    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 12, color: '#5A7A9A', marginTop: 4 }}>Panel NOC</p>
        </div>
        ...
        <div style={{
          ...
          {!requiere2FA && (
            <>
              ...
              <p style={{ fontSize: 12, color: '#8AAABB', margin: '0 0 24px' }}>Acceso para operadores NOC</p>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div>
                  ...
                  <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                    placeholder="noc@enetfiber.com" autoComplete="email" required
                    style={inputStyle}
          ...
          {requiere2FA && (
            <>
              ...
              <form onSubmit={handle2FA} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <button type="button" onClick={() => { useAuthStore.setState({ requiere2FA: false }); setError(''); setTotpCodigo(''); }}
