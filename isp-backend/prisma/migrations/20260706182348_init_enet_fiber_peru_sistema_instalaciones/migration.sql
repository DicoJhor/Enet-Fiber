-- CreateEnum
CREATE TYPE "TipoTrabajoPE" AS ENUM ('PROYECTO', 'AVERIA_MASIVA', 'MANTENIMIENTO');

-- CreateEnum
CREATE TYPE "EstadoTrabajoPE" AS ENUM ('EN_CURSO', 'COMPLETADO');
...
-- CreateTable
CREATE TABLE "trabajos_planta_externa" (
    "id" TEXT NOT NULL,
    "tipo" "TipoTrabajoPE" NOT NULL,
    "nombre" TEXT NOT NULL,
    "descripcion" TEXT,
    "ubicacion" TEXT,
    "estado" "EstadoTrabajoPE" NOT NULL DEFAULT 'EN_CURSO',
    ...
    CONSTRAINT "trabajos_planta_externa_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "tecnicos_trabajo_pe" (
    "id" SERIAL NOT NULL,
    "trabajo_id" TEXT NOT NULL,
    "tecnico_id" TEXT NOT NULL,

    CONSTRAINT "tecnicos_trabajo_pe_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "materiales_trabajo_pe" (
    "id" SERIAL NOT NULL,
    "trabajo_id" TEXT NOT NULL,
    "producto_id" INTEGER NOT NULL,
    "cantidad" DECIMAL(10,2) NOT NULL,
    ...
    CONSTRAINT "materiales_trabajo_pe_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "consumo_tecnico" ADD CONSTRAINT "consumo_tecnico_trabajo_pe_id_fkey" FOREIGN KEY ("trabajo_pe_id") REFERENCES "trabajos_planta_externa"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "trabajos_planta_externa" ADD CONSTRAINT "trabajos_planta_externa_sedeId_fkey" FOREIGN KEY ("sedeId") REFERENCES "sedes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tecnicos_trabajo_pe" ADD CONSTRAINT "tecnicos_trabajo_pe_trabajo_id_fkey" FOREIGN KEY ("trabajo_id") REFERENCES "trabajos_planta_externa"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tecnicos_trabajo_pe" ADD CONSTRAINT "tecnicos_trabajo_pe_tecnico_id_fkey" FOREIGN KEY ("tecnico_id") REFERENCES "tecnicos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "materiales_trabajo_pe" ADD CONSTRAINT "materiales_trabajo_pe_trabajo_id_fkey" FOREIGN KEY ("trabajo_id") REFERENCES "trabajos_planta_externa"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
